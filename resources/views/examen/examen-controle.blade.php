                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Controles List</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($controleList as $key=>$controle)
                                            <tr>
                                                <td>
                                                    <div class="form-check check-tables">
                                                        <input class="form-check-input" type="checkbox" value="something">
                                                ...
                                                <td><a href="{{url('examen/controle-list')}}">CC</a>{{ ++$key }}</td>
                                                <td hidden class="id">{{ $controle->id }}</td>
                                                <td class="date">
                                                    <a href="{{url('examen/controle-list')}}">
                                                        {{ date('d-m-Y', strtotime($controle->examen->date)) }}</td>
                                                    </a>
                                                <td class="course text-info">{{ $controle->examen->status }}</td>
                                                <td class="text-end">
