            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('setting/page/academicYear/update') }}" method="POST" enctype="application/x-www-form-urlencoded">
                                @csrf
                                <input type="hidden" class="form-control" name="id" value="{{ $academicYear->id }}" readonly>
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Academic Year Update
                                            <span>
                                                <a href="javascript:;"><i class="feather-more-vertical"></i></a>
                                            </span>
                                        </h5>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="{{ route('setting/page/academicYear') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 col-sm-4">
                                        <div class="form-group local-forms calendar-icon">
                                            ...
                                            <input class="form-control datetimepicker @error('date_of_birth') is-invalid @enderror" name="academic_year" type="text" placeholder="DD-MM-YYYY" value="{{ $academicYear->year }}">
                                            {{-- Need to be complete --}}
                                            @error('date_of_birth')
