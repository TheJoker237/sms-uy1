                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Search by Code UE ...">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('course/update') }}" method="POST" enctype="application/x-www-form-urlencoded">
                                @csrf
                                <input type="hidden" class="form-control" name="id" value="{{ $course->id }}" readonly>
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Course Update
                                            <span>
                                                <a href="javascript:;"><i class="feather-more-vertical"></i></a>
                                            </span>
                                        </h5>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <a href="{{ route('course/list') }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-3">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="code" placeholder="Enter Code UE" value="{{ $course->code }}">
                                            @error('code')
                                    ...
                                    <div class="col-12 col-sm-8">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="title" placeholder="Enter Title Course" value="{{ $course->title }}">
                                            @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
